...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
        ...
        let reason = args.slice(0).join(' ') || "Sebep girilmedi.";
        ...
        message.reply({ embeds: [embed.setDescription(`${author} **${sebep}** sebebiyle afk oldunuz.`)] }).catch((err) => console.log(err), client.ytick(message)).then((e) => setTimeout(() => { e.delete(); }, 10000));
    }
}